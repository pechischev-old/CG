...
void main()
{
    ...
    //vec4 matDiffuse2 = (material.diffuse + texture2D(diffuseMap, fragTextureUV.st)) * texture2D(textureDiffuseMap, fragTextureUV.st);
    //vec4 matDiffuse3 = material.diffuse * texture2D(textureDiffuseMap, fragTextureUV.st) + vec4(1,0,0,1);
